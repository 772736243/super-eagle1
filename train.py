        ...
        for i, (imgs, irs, targets, paths, _) in pbar:  # batch zjq  -------------------------------------------------------------
            ...
            if opt.multi_scale:
                ...
                if sf != 1:
                    ...
                    irs = F.interpolate(irs, size=ns, mode='bilinear', align_corners=False)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--super', action='store_true', default=True, help='super resolution')
    ...
    parser.add_argument('--hr_input', default=True, action='store_true', help='high resolution input(1024*1024)')
    ...
    if opt.resume and not wandb_run:  # resume an interrupted run
        ...
        opt_yaml = Path(ckpt).parent.parent / 'opt.yaml'  # train options yaml
        if opt_yaml.is_file():
