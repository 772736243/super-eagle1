...
def color_list():
    ...
    return [(255, 56, 56), (255, 157, 151), (255, 112, 31), (255, 178, 29), (207,210,49),
            (72,249,10), (146,204,23), (61,219,134), (26,147,52), (0,212,187),(44,153,169),(0,194,255),
...
def plot_one_box_PIL(box, img, color=None, label=None, line_thickness=None):
    ...
    line_thickness = line_thickness or max(int(min(img.size) / 200), 1)
...
def plot_labels(labels, names=(), save_dir=Path(''), loggers=None):
    ...
    labels[:, 1:] = xywh2xyxy(labels[:, 1:]) * 1000
    img = Image.fromarray(np.ones((1000, 1000, 3), dtype=np.uint8) * 255)
    for cls, *box in labels[:500]:
    ...
    for fi, f in enumerate(files):
        try:
            ...
            for i in range(10):
                ...
                ax[i].plot(x, y, marker='.', label=label, linewidth=1, markersize=8)
                ax[i].set_title(s[i], fontsize=12)
